...
const JobState = (props)=>{
    ...
    const BaseUrl = 'https://job-portal-api-o0eh.onrender.com'
...
const handleDelete = async(id) =>{
  ...
  const DeleteJob = async(id) =>{
    ...
    return(
        <JobContext.Provider value={{LoginS,LoginC,handleSubmitS,handleSubmitC,BaseUrl,token,getMyJobs,showAlert,alert,loginStudent,RegisterStudent,loginCompany,updateCompany,deleteCompany,getProfile,changePassword,jobs,DeleteJob,getJobs,postJob}}>
            {props.children}
        </JobContext.Provider>
    )
}
